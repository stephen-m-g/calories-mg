...
export function AddFoodVoiceScreen() {
  return (
    <SafeAreaView style={styles.container} edges={['bottom']}>
      <Ionicons name="mic-outline" size={40} color={colors.textMuted} />
      <Text style={styles.title}>Voice logging</Text>
      <Text style={styles.subtitle}>Describe your meal out loud and have it parsed automatically — coming in a later phase.</Text>
    </SafeAreaView>
  );
}
